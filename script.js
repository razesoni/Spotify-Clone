...
async function getsongs(folder) {
    currfolder = folder;
    let a = await fetch(`https://razesoni.github.io/Spotify-Clone/${folder}/`);
...
const playMusic = (track, pause = false) => {
    currentsong.src = `https://razesoni.github.io/Spotify-Clone/${currfolder}/${track}`; // Ensure the correct path
    if (!pause) {
        currentsong.play();
...
async function displayAlbums() {
    let a = await fetch(`https://razesoni.github.io/Spotify-Clone/song/`);
    let response = await a.text();
    let div = document.createElement("div");
    div.innerHTML = response;
    ...
    if (e.href.includes("/song")) {
        ...
        let a = await fetch(`https://razesoni.github.io/Spotify-Clone/${folder}/info.json`);
        ...
        cardContainer.innerHTML = cardContainer.innerHTML + `<div data-folder="${folder}" class="card">
                        ...
                        <img src="https://razesoni.github.io/Spotify-Clone/song/${folder}/cover.jpg" alt="">
